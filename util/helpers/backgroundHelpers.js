...
export const generateBackgroundControlStyles = ({
  ...
  const backgroundStylesDesktop = `
      background-image: ${
        noMainBgi === false && backgroundType === "classic" && bgImageURL
          ? `url("${bgImageURL}")`
  ...
  const hoverBackgroundStylesDesktop = `
    ...
    ${
      noMainBgi === false && hov_backgroundType === "classic" && hov_bgImageURL
        ? `
        ${
        ...
        ${
          hov_backgroundColor
            ? `background-color: ${hov_backgroundColor};`
            : " "
        }
  ...
  const overlayStylesDesktop = `
      ...
      ${
        ...
        ${
          noOverlayBgi === false && overlayType === "classic" && ovl_bgImageURL
            ? `
            ${
  ...
  const bgTransitionStyle = `background ${bg_transition || 0}s`;

  const ovlTransitionStyle = `background ${ovl_bg_transition || 0}s, opacity ${
